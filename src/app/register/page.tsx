...
function RegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2">
        <Label htmlFor="confirm" className="text-sm font-serif-display tracking-wide">
          确认密码
        </Label>
        <Input
          id="confirm"
          ...
          required
          className="h-11 bg-input/40 border-border font-mono-pretty"
        />
      </div>
      ...
      >
        {loading ? (
          <span className="text-sm">正在创建</span>
        ) : (
          <>
